<template>
  <NuxtLayout name="admin" page-title="แผนก" page-description="จัดการแผนกและหน่วยงานในโรงเรียน">
...
const fetchItems = async () => {
  loading.value = true
  try {
    const response = await apiFetch<any>('/departments', { params: { page: pagination.value.page, limit: pagination.value.limit } })
