<template>
  <NuxtLayout name="admin" page-title="พฤติกรรมนักเรียน" page-description="ติดตามและบันทึกพฤติกรรมของนักเรียน">
...
const columns = [
  ...
  { key: 'behavior_type', label: 'ประเภทพฤติกรรม' },
...
const fetchItems = async () => {
  loading.value = true
  try {
    const response = await apiFetch<any>('/student-behaviors', {
