<template>
  <AdminDetailPageShell
    page-title="รายละเอียดคะแนน"
    page-description="ข้อมูลรายการประเมินและผลคะแนน"
    back-path="/teacher/grades"
    :loading="loading"
    :has-data="!!detail"
    not-found-text="ไม่พบข้อมูลคะแนน"
  >
...
const fetchDetail = async () => {
  ...
  try {
    ...
    detail.value = null
    error('ไม่สามารถโหลดรายละเอียดคะแนนได้')
  } finally {
    loading.value = false
  }
}
